...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hummingbird-ml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12204&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hummingbird-ml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hummingbird-ml` can be installed with:

```
conda install hummingbird-ml
```

It is possible to list all of the versions of `hummingbird-ml` available on your platform with:
